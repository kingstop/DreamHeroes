...
void protobuf_AssignDesc_common_2eproto() {
  ...
  static const int MsgHeroData_offsets_[20] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgHeroData, daily_game_have_been_reset_),
  };
...
void protobuf_AddDesc_common_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "GoldShopConfigInfo\022\n\n\002id\030\001 \002(\005\022\023\n\013resour"
    "ce_id\030\002 \002(\005\022\014\n\004gold\030\003 \002(\005\022\r\n\005money\030\004 \002(\002"
    "\022\020\n\010describe\030\005 \002(\t\022\r\n\005jewel\030\006 \002(\005\"p\n\017Msg"
    "HeroDealInfo\022\020\n\010order_id\030\001 \002(\t\022\022\n\nproduc"
    "t_id\030\002 \002(\t\022#\n\004type\030\003 \002(\0162\025.message.HeroD"
    "ealType\022\022\n\ncreatetime\030\004 \002(\r*4\n\007SubType\022\013"
    "\n\007DEFAULT\020\000\022\013\n\007MONSTER\020\001\022\017\n\013INTERACTIVE\020"
    "\002*\340\001\n\010TaskType\022\021\n\rTaskType_NULL\020\000\022\030\n\024Tas"
    "kType_KillMonster\020\001\022\025\n\021TaskType_PassGame"
    "\020\002\022\024\n\020TaskType_UnKnown\020\003\022\027\n\023TaskType_Lim"
    "itLevel\020\004\022\030\n\024TaskType_LimitRevive\020\005\022\"\n\036T"
    "askType_LimitTime_KillMonster\020\006\022#\n\037TaskT"
    "ype_Accumulate_KillMonster\020\007*v\n\014HeroDeal"
    "Type\022\031\n\025HeroDealTypApplyOrder\020\000\022\031\n\025HeroD"
    "ealTypeWaitToPay\020\001\022\030\n\024HeroDealTypeComple"
    "te\020\002\022\026\n\022HeroDealTypeFailed\020\003", 2268);
...
const int MsgHeroData::kDailyGameHaveBeenResetFieldNumber;
#endif  // !_MSC_VER
...
#define ZR_(first, last) do {\
  ...
  ZR_(daily_game_record_progress_, daily_game_have_been_reset_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 19: {
        ...
        if (input->ExpectTag(160)) goto parse_daily_game_have_been_reset;
        break;
      }
      ...
      case 20: {
        if (tag == 160) {
         parse_daily_game_have_been_reset:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &daily_game_have_been_reset_)));
...
void MsgHeroData::SerializeWithCachedSizes(
  ...
  // required bool daily_game_have_been_reset = 20;
  if (has_daily_game_have_been_reset()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(20, this->daily_game_have_been_reset(), output);
  }
...
::google::protobuf::uint8* MsgHeroData::SerializeWithCachedSizesToArray(
  ...
  // required bool daily_game_have_been_reset = 20;
  if (has_daily_game_have_been_reset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(20, this->daily_game_have_been_reset(), target);
  }
...
void MsgHeroData::MergeFrom(const MsgHeroData& from) {
  ...
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    ...
    if (from.has_daily_game_have_been_reset()) {
      set_daily_game_have_been_reset(from.daily_game_have_been_reset());
    }
  }
  if (from._internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->MergeFrom(from.unknown_fields());
...
void MsgHeroData::InternalSwap(MsgHeroData* other) {
  ...
  std::swap(daily_game_have_been_reset_, other->daily_game_have_been_reset_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// required bool daily_game_have_been_reset = 20;
 bool MsgHeroData::has_daily_game_have_been_reset() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
 void MsgHeroData::set_has_daily_game_have_been_reset() {
  _has_bits_[0] |= 0x00080000u;
}
 void MsgHeroData::clear_has_daily_game_have_been_reset() {
  _has_bits_[0] &= ~0x00080000u;
}
 void MsgHeroData::clear_daily_game_have_been_reset() {
  daily_game_have_been_reset_ = false;
  clear_has_daily_game_have_been_reset();
}
 bool MsgHeroData::daily_game_have_been_reset() const {
  // @@protoc_insertion_point(field_get:message.MsgHeroData.daily_game_have_been_reset)
  return daily_game_have_been_reset_;
}
 void MsgHeroData::set_daily_game_have_been_reset(bool value) {
  set_has_daily_game_have_been_reset();
